...
#
class MultiChannelModel(CUTModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
           ...
           # parser.add_argument('--degree', type=int, default=20, help='weight for L1 loss')
           # parser.add_argument('--transl', type=int, default=5, help='weight for L1 loss')
        return parser
