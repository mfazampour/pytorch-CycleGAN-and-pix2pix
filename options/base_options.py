...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='resnet_4blocks', choices=['global','local','encoder','resnet_9blocks', 'resnet_4blocks', 'unet_3D','resnet_6blocks', 'unet_256', 'unet_128', 'unet_small', 'stylegan2', 'unet_small','smallstylegan2', 'resnet_cat'], help='specify generator architecture')
