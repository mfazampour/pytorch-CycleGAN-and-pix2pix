...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netG', type=str, default='resnet_4blocks', choices=['global','NormalNet','local','encoder','resnet_7blocks', 'resnet_9blocks', 'resnet_4blocks', 'unet_3D','resnet_6blocks', 'unet_256', 'unet_128', 'unet_small', 'resnet_cat', 'drit', 'drit_orig'], help='specify generator architecture')
